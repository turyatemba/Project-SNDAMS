...
//#define USE_WIFI_SHIELD
  ...
  char ssid[] = "unidentified";          //  your network SSID (name) 
  char pass[] = "tron@2016";   // your network password
  int status = WL_IDLE_STATUS;
  WiFiClient  client;
...
/*
  ...
  *****************************************************************************************/
unsigned long myChannelNumber = 107785;
const char * myWriteAPIKey = "1F7LUQS3C5MIEI8Q";
